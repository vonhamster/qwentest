...
class Router {
    ...
    registerController(controllerClass, basePath) {
        ...
        routes.forEach(route => {
            ...
            const handler = async (req, res) => {
                try {
                    ...
                    const actionMethod = route.action;
                    if (typeof ctrl[actionMethod] === 'function') {
                        await ctrl[actionMethod].call(ctrl);
                    }
                    else {
    ...
    registerRestController(controllerClass, basePath) {
